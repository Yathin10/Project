...
const BACKEND_URL = '/process'; // Relative URL
...
function displayResults(results) {
    ...
    const resultsData = [
        { title: 'Heart Rate', value: `${results.heartRate} bpm`, icon: '<i class="fa-solid fa-heart-pulse"></i>' },
        { title: 'Blood Pressure', value: `${results.systolic}/${results.diastolic} mmHg`, icon: '<i class="fa-solid fa-droplet"></i>' },
        { title: 'Stress Level', value: results.stress, icon: '<i class="fa-solid fa-brain"></i>' }
    ];

    resultsData.forEach((data, index) => createResultBox(data.title, data.value, data.icon, index * 0.2));
